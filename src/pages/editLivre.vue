...
const categories = [
    ...
    'Policier', 'Horreur', 'Historique', 'Biographie', 'Autre'
]
                    ...
                    <div class="form-col-right">
                        ...
                        <div class="preview-publish-row">
                            ...
                            <div class="publish-side">
                                <button type="button" class="btn-annuler" @click="handleDelete" :disabled="isLoading"
                                    style="width: 100%;">
                                    {{ isLoading ? '...' : 'Supprimer' }}
                                </button>

                                <button type=" submit" class="btn-submit" :disabled="isLoading" style="width: 100%;">
                                    {{ isLoading ? 'Enregistrement...' : 'Enregistrer' }}
                                </button>

                                <button type="button" class="btn-annuler" @click="goBack" style="width: 100%;">
                                    Annuler
                                </button>
                            </div>
                        </div>
